...
E char *FDECL(mon_nam_or_sth, (struct monst *));
E char *FDECL(noit_mon_nam, (struct monst *));
E char *FDECL(Monnam, (struct monst *));
E char *FDECL(Monnam_or_sth, (struct monst *));
...
E char *FDECL(Amonnam_or_sth, (struct monst *));
...
E int FDECL(mon_resist, (struct monst *, CHAR_P));
