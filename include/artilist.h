...
A("Firewall",                  ATHAME,
	...
	FIRE(4,4),      FIRE(0,0),      NO_CARY,        SUMMON_FIRE_ELEMENTAL, A_LAWFUL, PM_FLAME_MAGE, NON_PM, 400L ),
#else
A("Firewall",                  ATHAME,
	(SPFX_RESTR|SPFX_ATTK|SPFX_DEFN), 0, 0,
...
A("Giantkiller",                AXE,
	...
	PHYS(8,20),	NO_DFNS,	NO_CARY,	0, A_NEUTRAL, NON_PM, NON_PM, 800L ),
...
A("Orcrist",                    ELVEN_BROADSWORD,
	(SPFX_DFLAG2|SPFX_WARN), 0, M2_ORC,
...
A("Dragonbane",			DWARVISH_SPEAR,
	...
	PHYS(8,15),	NO_DFNS,	NO_CARY,	0, A_NONE, NON_PM, NON_PM, 500L ),
...
A("Demonbane",			SILVER_LONG_SWORD,
	(SPFX_WARN|SPFX_RESTR|SPFX_DFLAG2|SPFX_DEFN), 0, M2_DEMON,
	PHYS(8,0),	DRLI(0,0),	NO_CARY,	0, A_LAWFUL, NON_PM, NON_PM, 2500L ),

A("Werebane",			SILVER_SABER,
	(SPFX_WARN|SPFX_RESTR|SPFX_DFLAG2), 0, M2_WERE,
	PHYS(8,0),	DFNS(AD_WERE),	NO_CARY,	0, A_NONE, NON_PM, NON_PM, 1500L ),
...
A("Trollsbane",                 MORNING_STAR,
	...
	PHYS(8,20),	NO_DFNS,	NO_CARY,	0, A_NONE, NON_PM, NON_PM, 800L ),

A("Ogresmasher",		WAR_HAMMER,
	(SPFX_RESTR|SPFX_DCLAS), 0, S_OGRE,
	PHYS(8,20),	NO_DFNS,	NO_CARY,	0, A_NONE, NON_PM, NON_PM, 1000L ),
...
A("Deep Freeze",                ATHAME,
	(SPFX_RESTR|SPFX_ATTK|SPFX_DEFN), 0, 0,
	COLD(5,5),      COLD(0,0),      NO_CARY,        SUMMON_WATER_ELEMENTAL, A_CHAOTIC, PM_ICE_MAGE, NON_PM, 400L ),
#else
A("Deep Freeze",                ATHAME,
	(SPFX_RESTR|SPFX_ATTK|SPFX_DEFN), 0, 0,
...
A("Nighthorn", UNICORN_HORN,
	...
	NO_ATTK,        NO_DFNS,        NO_CARY,
	SCARING,      A_LAWFUL, NON_PM, NON_PM, 10000L ),
...
A("The Palantir of Westernesse",	CRYSTAL_BALL,
	SPFX_RESTR,     0,              0,
	NO_ATTK,	NO_DFNS,	NO_CARY,
	TAMING,		A_NONE, NON_PM , NON_PM, 1000L ),
#endif
...
A("The Mitre of Holiness",	HELM_OF_BRILLIANCE,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_DCLAS|SPFX_INTEL|SPFX_PROTECT), 0, M2_UNDEAD,
	NO_ATTK,	NO_DFNS,	CARY(AD_FIRE),
...
A("The Tsurugi of Muramasa",	TSURUGI,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_INTEL|SPFX_BEHEAD|SPFX_LUCK|SPFX_PROTECT), 0, 0,
	NO_ATTK,        NO_DFNS,        NO_CARY,
