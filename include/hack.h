...
#define MATCH_WARN_OF_MON(mon)	 (Warn_of_mon && typewarned && \
		   		 (typewarned & (mon)->data->mflags2))
...
#define EXPL_SHOCK	6	/* Graphically same as frosty effect */
#define EXPL_MAX	7
...
#define inmap(x,y)	(x >= 0 && x < COLNO && y >= 0 && y < ROWNO)
