...
int rtype;
{
	...
	switch(rtype) {
		...
		case ARMORSHOP:
			return "armor dealership";
		case SCROLLSHOP:
			return "second-hand bookstore";
		case POTIONSHOP:
			return "liquor emporium";
		case WEAPONSHOP:
			return "weapons outlet";
		case FOODSHOP:
			return "delicatessen";
		case RINGSHOP:
			return "jewelers";
		case WANDSHOP:
			return "quality apparel & accessories";
		case BOOKSHOP:
			return "rare book shop";
		case TOOLSHOP:
			return "hardware store";
		case PETSHOP:
			return "pet store";
		case TINSHOP:
			return "frozen food store";
		case CANDLESHOP:
