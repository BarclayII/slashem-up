            ...
            do { /* hero can't move this turn loop */
                ...
                if (!monscanmove && youmonst.movement < NORMAL_SPEED) {
                    ...
                    if (u.uinvulnerable) {
                         ...
                         * Healthstones have been added, which alter your
                         * effective experience level and constitution (-2
                         * cursed, +1 uncursed, +2 blessed) for the basis of
                    ...
                    if ((u.uen < u.uenmax) && 
                        ...
                        u.uen += rn1((int)(ACURR(A_WIS) + ACURR(A_INT))/15 + 1,
                                     1);
