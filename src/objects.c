...
BULLET("bullet", (char *)0,
	1,  4,   1,   5, 20, 30, 0, WP_BULLET,   P,   IRON, -P_FIREARM, HI_METAL),
BULLET("silver bullet", (char *)0,
	1,  2,   1,  15, 20, 30, 0, WP_BULLET,   P, SILVER, -P_FIREARM, HI_SILVER),
#else
BULLET("bullet", (char *)0,
...
CLOAK("lab coat", "white coat",
		0, 1,   POISON_RES,10, 0, 10, 60,  9, 1, CLOTH, CLR_WHITE),
