...
STATIC_PTR int NDECL(donamelevel_or_toggle_invuln);
...
STATIC_PTR int
donamelevel_or_toggle_invuln()
{
#ifdef WIZARD
	if (wizard) return wiz_toggle_invulnerability();
	else
#endif
		donamelevel();
}
...
/* END TSANTH'S CODE */
	/*{C('o'), TRUE, wiz_where},*/
#endif
	{C('n'), TRUE, donamelevel_or_toggle_invuln},
	{C('o'), TRUE, dooverview_or_wiz_where},
