 ...
 */
	...
	A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4),
	  ATTK(AT_GAZE, AD_BLND, 4, 6), ATTK(AT_CLAW, AD_PHYS, 3, 8),
	  ATTK(AT_MAGC, AD_SPEL, 4, 6), NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_CUSS, MZ_LARGE),
	MR_DEATH|MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_PLUSFOUR,
	0, M1_FLY|M1_HUMANOID|M1_SEE_INVIS|M1_REGEN,
 ...
 */
	...
	LVL(8, 6, 2, 30, 0), (G_NOHELL|G_NOCORPSE|2),
	A(ATTK(AT_CLAW, AD_PHYS, 4, 6), ATTK(AT_NONE, AD_PLYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	M1_ANIMAL|M1_HUMANOID|M1_CARNIVORE,
	M2_GIANT|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BROWN),
    MON("titan", S_GIANT,
	...
	M2_GIANT|M2_STRONG|M2_ROCKTHROW|M2_NASTY|M2_COLLECT|M2_MAGIC,
 ...
 */
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	M2_UNDEAD|M2_HOSTILE|M2_HUMAN, M3_INFRAVISION, CLR_GRAY),
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	M2_GIANT|M2_UNDEAD|M2_HOSTILE|M2_STRONG, M3_INFRAVISION, CLR_BLUE),
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS|M1_REGEN,
 ...
 */
	...
	LVL(5, 3, 8, 0, 0), (G_NOHELL|G_GENO|G_NOCORPSE|1),
	...
	LVL(10, 6, 6, 0, 0), (G_NOHELL|G_GENO|G_NOCORPSE|1),
...
#else
    MON("Doctor Frankenstein", S_QUANTMECH,
	LVL(25, 12, -10, 75, 0), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_TUCH, AD_ELEC, 5, 6),
	  ATTK(AT_CLAW, AD_TLPT, 1, 4), ATTK(AT_CLAW, AD_POLY, 1, 4), NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 20, 0, MS_HUMANOID, MZ_HUMAN), MR_STONE|MR_POISON|MR_ELEC|MR_SLEEP, 0,
	M1_HUMANOID|M1_OMNIVORE|M1_POIS|M1_TPORT, 
	M2_HOSTILE|M2_NOPOLY|M2_MALE|M2_PNAME, M3_INFRAVISIBLE|M3_NOTAME, HI_LORD),
#endif
/*
 ...
 */
	...
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_HUMAN), MR_SLEEP|MR_POISON|MR_COLD|MR_FIRE|MR_PLUSTHREE, 0,
  	M1_FLY|M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN|M1_CARNIVORE,
	...
	A(ATTK(AT_TENT, AD_PHYS, 2, 6), ATTK(AT_TENT, AD_DRLI, 2, 6),
	  ...
	  ATTK(AT_TENT, AD_PHYS, 2, 6), ATTK(AT_TENT, AD_DRLI, 2, 6)),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_SLEEP|MR_POISON|MR_COLD|MR_PLUSTHREE, 0,
	M1_FLY|M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN|M1_CARNIVORE,
	M2_VAMPIRE|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_NEUTER,
 ...
 */
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID,
	M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_HUMAN, M3_INFRAVISION, HI_DOMESTIC),
    MON("ghoul", S_ZOMBIE,
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID,
	M2_GIANT|M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_STRONG, M3_INFRAVISION, CLR_BLUE),
    MON("ghast", S_ZOMBIE, 
...
#else
    MON("Frankenstein's Monster", S_GOLEM,
	LVL(23, 8, -5, 50, 0), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_CLAW, AD_PHYS, 3, 8), ATTK(AT_CLAW, AD_PHYS, 3, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1400, 600, 0, MS_SILENT, MZ_LARGE),
	MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON,
 ...
 */
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_TUCH, AD_SITM, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
	  ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_DJINNI, MZ_HUMAN),
	MR_FIRE|MR_POISON|MR_HITASTWO, 0,
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_HUMAN), MR_FIRE|MR_POISON|MR_HITASONE, 0,
...
#undef SEDUCTION_ATTACKS
	...
	A(ATTK(AT_WEAP, AD_DRST, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_HUMAN), MR_FIRE|MR_POISON|MR_HITASTWO, 0,
	M1_HUMANOID|M1_POIS,
	...
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  ...
	  ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4)),
	SIZ(WT_HUMAN, 400, 0, MS_CUSS, MZ_LARGE), MR_FIRE|MR_POISON|MR_HITASTWO, 0,
	...
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_FIRE|MR_POISON|MR_HITASTWO, 0,
	...
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_FIRE|MR_POISON|MR_HITASTHREE, 0,
	...
	A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE),
	MR_FIRE|MR_COLD|MR_POISON|MR_HITASTHREE, 0, M1_SEE_INVIS|M1_POIS,
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY, M3_INFRAVISIBLE|M3_INFRAVISION|M3_TRAITOR,
	CLR_WHITE),
    MON("lava devil", S_DEMON,
	LVL(12, 12, -4, 40, -7), (G_HELL|G_NOCORPSE|2),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_BITE, AD_PHYS, 1, 8),
	  ATTK(AT_BITE, AD_FIRE, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_HUMAN),
	MR_FIRE|MR_POISON|MR_HITASTHREE, 0,
	M1_HUMANOID|M1_POIS,
	M2_NOPOLY|M2_DEMON|M2_HOSTILE|M2_STALK|M2_NASTY|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOTAME|M3_TRAITOR, CLR_RED),
    MON("nalfeshnee", S_DEMON,
	LVL(11, 9, -1, 65, -11), (G_HELL|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  ATTK(AT_BITE, AD_PHYS, 2, 4), ATTK(AT_MAGC, AD_SPEL, 0, 0),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SPELL, MZ_LARGE), MR_FIRE|MR_POISON|MR_HITASTHREE, 0,
	M1_HUMANOID|M1_POIS, M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_TRAITOR, CLR_RED),
    MON("nabassu", S_DEMON, 
	...
	A(ATTK(AT_WEAP, AD_PHYS, 4, 2), ATTK(AT_WEAP, AD_PHYS, 4, 2),
	  ATTK(AT_HUGS, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_GROWL, MZ_LARGE), MR_FIRE|MR_POISON|MR_HITASFOUR, 0,
	M1_SEE_INVIS|M1_POIS,
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_TRAITOR, CLR_RED),
    MON("fallen angel", S_DEMON,
	LVL(14, 10, -4, 55, 12), (G_HELL|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_MAGC, AD_MAGM, 2, 6),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_HUMAN),
	MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_PLUSTHREE, 0,
	M1_FLY|M1_HUMANOID|M1_SEE_INVIS,
	M2_STRONG|M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_TRAITOR|M3_NOTAME, CLR_WHITE),
    MON("balrog", S_DEMON,
	LVL(16, 5, -2, 75, -14), (G_HELL|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_PHYS, 8, 4), ATTK(AT_WEAP, AD_PHYS, 4, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_FIRE|MR_POISON|MR_HITASFOUR|MR_PLUSTWO, 0,
	M1_FLY|M1_SEE_INVIS|M1_POIS,
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_TRAITOR, CLR_RED),
    MON("nessian pit fiend", S_DEMON,
	LVL(16, 12, -3, 99, 15), (G_HELL|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_PHYS, 4, 2), ATTK(AT_CLAW, AD_PHYS, 4, 2),
	  ATTK(AT_BITE, AD_DRST, 3, 4), ATTK(AT_MAGC, AD_SPEL, 0, 9),
	  ATTK(AT_NONE, AD_FIRE, 8, 2), NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE),
	MR_FIRE|MR_POISON|MR_HITASFOUR, 0,
	M1_FLY|M1_HUMANOID|M1_SEE_INVIS|M1_POIS,
	M2_HOSTILE|M2_STALK|M2_NASTY|M2_COLLECT|M2_DEMON,
	M3_WAITFORU|M3_TRAITOR|M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOTAME,
	CLR_RED),
    MON("shayateen", S_DEMON,
	LVL(18, 18, -5, 66, -15), (G_HELL|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_CLAW, AD_PHYS, 3, 4),
	  ATTK(AT_HUGS, AD_PHYS, 4, 6), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(2900, 400, 0, MS_SILENT, MZ_LARGE),
	MR_FIRE|MR_POISON|MR_HITASFOUR|MR_PLUSTWO, 0,
	M1_FLY|M1_HUMANOID|M1_NOHANDS|M1_SEE_INVIS|M1_POIS,
	M2_HOSTILE|M2_DEMON|M2_STALK|M2_STRONG|M2_NASTY|M2_COLLECT,
	M3_TRAITOR|M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOTAME,
	CLR_RED),
    MON("ancient of ice", S_DEMON,
	LVL(15, 8, -6, 88, 14), (G_HELL|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_PHYS, 8, 8), ATTK(AT_GAZE, AD_COLD, 8, 8),
	  ATTK(AT_MAGC, AD_COLD, 8, 8), ATTK(AT_BOOM, AD_COLD, 11, 8),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE),
	MR_FIRE|MR_COLD|MR_POISON|MR_HITASFOUR, 0,
	M1_FLY|M1_HUMANOID|M1_SEE_INVIS|M1_POIS,
	M2_NOPOLY|M2_HOSTILE|M2_DEMON|M2_STALK|M2_STRONG|M2_NASTY|M2_COLLECT,
	M3_TRAITOR|M3_NOTAME|M3_INFRAVISION, CLR_WHITE),
    MON("ancient of death", S_DEMON,
	LVL(15, 4, -6, 88, -14), (G_HELL|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_DRLI, 11, 8), ATTK(AT_WEAP, AD_DETH, 11, 8),
	  ATTK(AT_BOOM, AD_PHYS, 11, 8), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE),
	MR_FIRE|MR_COLD|MR_POISON|MR_HITASFOUR, 0,
	M1_FLY|M1_WALLWALK|M1_HUMANOID|M1_SEE_INVIS|M1_POIS,
	M2_NOPOLY|M2_HOSTILE|M2_DEMON|M2_STALK|M2_STRONG|M2_NASTY|M2_COLLECT,
	M3_INFRAVISIBLE|M3_TRAITOR|M3_NOTAME, CLR_BLACK),
	/* Named demon lords & princes plus Arch-Devils.
	 * (their order matters; see minion.c)
	 */
    MON("Juiblex", S_DEMON,
	LVL(50, 3, -6, 65, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_ENGL, AD_DISE, 4,10), ATTK(AT_SPIT, AD_ACID, 3, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1500, 0, 0, MS_GURGLE, MZ_LARGE),
	MR_FIRE|MR_POISON|MR_ACID|MR_STONE|MR_HITASFOUR, 0,
	...
	SIZ(1500, 500, 0, MS_ORC, MZ_HUGE), MR_FIRE|MR_POISON|MR_HITASFOUR, 0,
	M1_FLY|M1_SEE_INVIS|M1_POIS,
	...
	HI_LORD),
    MON("Geryon", S_DEMON,
	LVL(72, 3, -8, 75, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
	  ATTK(AT_STNG, AD_DRST, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1500, 500, 0, MS_BRIBE, MZ_HUGE), MR_FIRE|MR_POISON|MR_HITASFOUR, 0,
	M1_FLY|M1_SEE_INVIS|M1_POIS|M1_SLITHY,
	M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|
	  M2_PRINCE|M2_MALE,
	M3_WAITFORU|M3_WANTSAMUL|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
    MON("Dispater", S_DEMON,
	LVL(78, 15, -8, 80, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 4, 6), ATTK(AT_MAGC, AD_SPEL, 6, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1500, 500, 0, MS_BRIBE, MZ_HUMAN), MR_FIRE|MR_POISON|MR_HITASFOUR, 0,
	M1_FLY|M1_SEE_INVIS|M1_POIS|M1_HUMANOID,
	M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|
	  M2_PRINCE|M2_MALE|M2_COLLECT,
	M3_WAITFORU|M3_WANTSAMUL|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
    MON("Baalphegor", S_DEMON,
	LVL(82, 8, -8, 90, 20), (G_NOCORPSE|G_HELL|G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
	  ATTK(AT_MAGC, AD_COLD, 8, 8), ATTK(AT_BOOM, AD_COLD, 10, 20),
	  NO_ATTK, NO_ATTK),
	SIZ(1500, 1500, 0, MS_GRUNT, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_POISON|MR_STONE|MR_DISINT|MR_HITASFOUR, 0,
	...
	LVL(89, 9, -9, 85, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_BITE, AD_DRST, 2, 6), ATTK(AT_GAZE, AD_STUN, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1500, 500, 0, MS_BRIBE, MZ_LARGE), MR_FIRE|MR_POISON|MR_HITASFOUR, 0,
	M1_FLY|M1_SEE_INVIS|M1_POIS,
	M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|
	  M2_PRINCE|M2_MALE,
	M3_WANTSAMUL|M3_WAITFORU|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
    MON("Leviathan", S_DEMON,
	LVL(94, 9, -9, 85, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
	  ATTK(AT_CLAW, AD_SLEE, 1, 9), ATTK(AT_ENGL, AD_DRIN, 1, 9),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN+1000, 2000, 0, MS_ROAR, MZ_HUGE),
	MR_COLD|MR_POISON|MR_SLEEP|MR_STONE|MR_DISINT|MR_HITASFOUR, 0,
	M1_SWIM|M1_SEE_INVIS|M1_POIS,
	M2_NOPOLY|M2_DEMON|M2_STRONG|M2_STALK|M2_HOSTILE|M2_PNAME|
	  M2_NASTY|M2_PRINCE|M2_MALE|M2_COLLECT,
	M3_WAITFORU|M3_WANTSAMUL|M3_INFRAVISION,
	HI_LORD),
    MON("Asmodeus", S_DEMON,
	LVL(105, 12, -10, 90, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_MAGC, AD_COLD, 6, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1500, 500, 0, MS_BRIBE, MZ_HUGE), MR_FIRE|MR_COLD|MR_POISON|MR_HITASFOUR, 0,
	M1_FLY|M1_SEE_INVIS|M1_HUMANOID|M1_POIS,
	M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|
	  M2_NASTY|M2_PRINCE|M2_MALE,
	M3_WANTSAMUL|M3_WAITFORU|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
    MON("Mammon", S_DEMON,
	LVL(105, 14, -10, 90, 20), (G_NOCORPSE|G_HELL|G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 3, 4), 
	  ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
	  ATTK(AT_HUGS, AD_PHYS, 3, 4),
	  ATTK(AT_CLAW, AD_GRAB, 1, 6), ATTK(AT_CLAW, AD_GRAB, 1, 6)
	  ),
	SIZ(1500, 1500, 0, MS_BRIBE, MZ_HUGE),
	MR_FIRE|MR_POISON|MR_STONE|MR_DISINT|MR_HITASFOUR, 0,
	...
	LVL(106, 15, -10, 95, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_MAGC, AD_SPEL, 8, 6), ATTK(AT_STNG, AD_DRLI, 1, 4),
	  ATTK(AT_CLAW, AD_DISE, 1, 6), ATTK(AT_CLAW, AD_DISE, 1, 6),
	  NO_ATTK, NO_ATTK),
	SIZ(1500, 500, 0, MS_GROWL, MZ_HUGE), MR_FIRE|MR_POISON|MR_HITASFOUR, 0,
	M1_FLY|M1_SEE_INVIS|M1_NOHANDS|M1_POIS,
	M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|
	  M2_PRINCE|M2_MALE,
	M3_WAITFORU|M3_WANTSAMUL|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
    MON("Lucifer", S_DEMON,
	LVL(107, 19, -13, 99, -20), (G_NOCORPSE|G_HELL|G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_ENCH, 2,8), ATTK(AT_WEAP, AD_ENCH, 2,8),
	  ATTK(AT_WEAP, AD_PHYS, 2,8), ATTK(AT_WEAP, AD_PHYS, 2,8),
	  ATTK(AT_CLAW, AD_STCK, 2, 8), ATTK(AT_GAZE, AD_RBRE, 8, 8)),
	SIZ(2000, 0, 0, MS_DJINNI, MZ_LARGE),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE|MR_HITASFOUR, 0,
   ...
   /* Cthulhu MUST be placed after Demogorgon so he will not be summoned as a 
    ...
    MON("Cthulhu", S_DEMON,
        LVL(120, 18, -15, 95, 0), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	MR_POISON|MR_STONE|MR_DISINT|MR_SLEEP|MR_ACID|MR_HITASFOUR, 0,
	 ...
	 */
    MON("Death", S_DEMON,
	LVL(45, 12, -5, 100, 0), (G_UNIQ|G_NOGEN),
 ...
 */
	...
	M2_HOSTILE, 0, CLR_BLUE),
    MON("piranha", S_EEL,
	LVL(5, 12, 4, 0, 0), (G_GENO|/*G_NOGEN*/2|G_SGROUP),
	...
	M2_HOSTILE, 0, CLR_RED),
    MON("giant eel", S_EEL,
	LVL(5, 9, -1, 0, 0), (G_GENO|/*G_NOGEN*/1),
    ...
    MON("shark", S_EEL,
	LVL(7, 12, 2, 0, 0), (G_GENO|/*G_NOGEN*/1),
	...
	LVL(7, 12, 0, 0, 0), (G_GENO|/*G_NOGEN*/1),
	A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(7, 10, -3, 0, 0), (G_GENO|/*G_NOGEN*/1),
 ...
 */
	...
	MR_POISON|MR_FIRE|MR_COLD|MR_ELEC|MR_STONE|MR_DEATH|MR_HITASTWO,
	...
	A(ATTK(AT_GAZE, AD_DETH, 1, 4), ATTK(AT_GAZE, AD_PHYS, 3, 8),
	  ...
	  ATTK(AT_GAZE, AD_SLEE, 1, 4), ATTK(AT_BITE, AD_DRLI, 3, 8)),
	SIZ(500, 100, 0, MS_SILENT, MZ_LARGE),
	MR_DEATH|MR_STONE|MR_PLUSTWO|MR_SLEEP, 0,
 ...
 */
	...
	LVL(10, 12, 10, 1, 0), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 10), NO_ATTK,
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_STRONG|M2_COLLECT, M3_INFRAVISIBLE, HI_DOMESTIC),
	...
	LVL(10, 12, 10, 0, 1), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  ATTK(AT_CLAW, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 10),
	  ATTK(AT_MAGC, AD_CLRC, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_CLAW, AD_PHYS, 1, 8), ATTK(AT_KICK, AD_PHYS, 1, 8),
	  ATTK(AT_CLAW, AD_STUN, 1, 3), ATTK(AT_KICK, AD_STUN, 1, 3),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
    ...
    MON("necromancer", S_HUMAN, 
        LVL(10, 12, 10, 3, 0), (1),
	A(ATTK(AT_WEAP, AD_DRLI, 1, 6), ATTK(AT_MAGC, AD_SPEL, 0, 0), 
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(10, 12, 10, 1, -3), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  ATTK(AT_WEAP, AD_DRST, 1, 3), ATTK(AT_TUCH, AD_SITM, 1, 4),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
 ...
 */
	...
	LVL(20, 12, 0, 30, -20), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
	  ATTK(AT_CLAW, AD_SAMU, 2, 4), ATTK(AT_CLAW, AD_GRAB, 1, 4),
	  NO_ATTK, NO_ATTK),
 ...
 */
...
#endif
    MON("Neptulon", S_ELEMENTAL,
	LVL(25, 6, -10, 50, -10), (G_NOGEN|G_UNIQ|G_NOCORPSE),
	A(ATTK(AT_MAGC, AD_SPEL, 0, 0), ATTK(AT_MAGC, AD_SPEL, 0, 0),
	  ATTK(AT_CLAW, AD_PHYS, 6, 6), ATTK(AT_CLAW, AD_PHYS, 6, 4),
	  ATTK(AT_CLAW, AD_SAMU, 1, 4), ATTK(AT_NONE, AD_COLD, 4, 4)),
	SIZ(2500, 0, 0, MS_NEMESIS, MZ_HUGE), MR_DEATH|MR_POISON|MR_COLD|
	MR_STONE|MR_HITASFOUR|MR_ELEC, 0, 
	M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_AMPHIBIOUS|M1_SWIM,
	M2_NOPOLY|M2_STRONG|M2_STALK|M2_HOSTILE|M2_NASTY|M2_COLLECT|
	M2_MAGIC|M2_MALE|M2_PNAME|M2_LORD, M3_WANTSARTI|M3_WAITFORU, CLR_BLUE),
#if 0	/* OBSOLETE */
    MON("Lareth", S_HUMAN, 
	...
	A(ATTK(AT_MAGC, AD_CLRC, 0, 0), ATTK(AT_MAGC, AD_CLRC, 0, 0),
	  ATTK(AT_CLAW, AD_FIRE, 6, 6), ATTK(AT_CLAW, AD_PHYS, 6, 4),
	  ATTK(AT_CLAW, AD_SAMU, 1, 4), ATTK(AT_NONE, AD_FIRE, 4, 4)),
	SIZ(2500, 0, 0, MS_NEMESIS, MZ_HUGE), MR_DEATH|MR_POISON|MR_FIRE|
	MR_STONE|MR_HITASFOUR|MR_ACID, 0, 
	M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_UNSOLID|M1_FLY,
	M2_NOPOLY|M2_STRONG|M2_STALK|M2_HOSTILE|M2_NASTY|M2_COLLECT|
	M2_MAGIC|M2_MALE|M2_PNAME|M2_LORD, 
	M3_WANTSARTI|M3_WAITFORU, CLR_YELLOW),
    MON("Ixoth", S_DRAGON,
	...
	LVL(15, 18, 10, 0, -15), (G_NOGEN|G_UNIQ),
