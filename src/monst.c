 ...
 */
	...
	LVL(25, 10, -10, 10, 20), (G_NOGEN|G_UNIQ|G_NOCORPSE),
	A(ATTK(AT_MAGC, AD_SPEL, 0, 0), ATTK(AT_MAGC, AD_SPEL, 0, 0),
	  ATTK(AT_CLAW, AD_COLD, 8, 8), ATTK(AT_CLAW, AD_PHYS, 8, 6),
	  ATTK(AT_CLAW, AD_SAMU, 1, 4), ATTK(AT_NONE, AD_COLD, 0, 4)),
	SIZ(2500, 0, 0, MS_NEMESIS, MZ_HUGE), MR_DEATH|MR_POISON|MR_COLD|
	MR_STONE|MR_HITASFOUR, 0, 
	M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_AMPHIBIOUS|M1_SWIM,
	M2_NOPOLY|M2_STRONG|M2_STALK|M2_HOSTILE|M2_NASTY|M2_COLLECT|
	M2_MAGIC, M3_WANTSARTI|M3_WAITFORU, CLR_BLUE),
#if 0	/* OBSOLETE */
    MON("Lareth", S_HUMAN, 
	...
	LVL(25, 10, -10, 10, 20), (G_NOGEN|G_UNIQ|G_NOCORPSE),
	A(ATTK(AT_MAGC, AD_SPEL, 0, 0), ATTK(AT_MAGC, AD_CLRC, 0, 0),
	  ATTK(AT_CLAW, AD_FIRE, 8, 8), ATTK(AT_CLAW, AD_PHYS, 8, 6),
	  ATTK(AT_CLAW, AD_SAMU, 1, 4), ATTK(AT_NONE, AD_FIRE, 0, 4)),
	SIZ(2500, 0, 0, MS_NEMESIS, MZ_HUGE), MR_DEATH|MR_POISON|MR_FIRE|
	MR_STONE|MR_HITASFOUR, 0, 
	M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_UNSOLID|M1_FLY,
	M2_NOPOLY|M2_STRONG|M2_STALK|M2_HOSTILE|M2_NASTY|M2_COLLECT|
	M2_MAGIC, M3_WANTSARTI|M3_WAITFORU, CLR_YELLOW),
    MON("Ixoth", S_DRAGON,
